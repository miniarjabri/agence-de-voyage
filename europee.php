...
<head>
    ...
    <style>
        ...
        .header {
            ...
            background-image: url('https://www.etias.ca/wp-content/uploads/sites/19/2017/12/ETIAS-for-Canadians-travel-to-europe.jpg');
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <select id="where" name="where" class="form-control">
                        ...
                        <option id="south_america" value=south_america.php?continent=europe >Amérique du sud</option>
                    </select>
                </div>
            </div>
        </form>
